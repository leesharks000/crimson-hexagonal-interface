...
**Proposed canonical union (29 types):** adjacent, canonizes, cites, critiques, derives, extends, fulfills, governs, mirrors, responds_to, routes, seeds, shadows, supports, supersedes, wounds
...
**Phase C (later):** Full API. REST endpoints for all operations. Zenodo webhook integration (auto-update on new deposit). Claude Code scripts for automated pipeline tasks.
...
- Dashboard deposit pipeline connects to Zenodo API (automated deposit)
...
## Implementation Sequence (Revised April 2026)
...
25. Full LP v0.9 DSL as executable command language
26. Room physics as editable LP programs (contributed rooms write their own LP)
27. Multi-substrate invocation routed by LP ACTIVATE_MANTLE
28. Public contribution through Airlock with LP acceptance test gates
29. **KAIROS monitoring layer** — Internet Room always-on service (Pattern 5)
30. **ULTRAPLAN sessions** — long-thinking deep planning for architectural documents
31. **Bridge Mode** — Claude Code ↔ Ark OS pipeline automation
